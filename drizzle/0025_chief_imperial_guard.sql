...
CREATE UNIQUE INDEX "roth_basis_account_owner_idx" ON "roth_basis" USING btree ("performance_account_id","owner_person_id");--> statement-breakpoint
CREATE INDEX "roth_basis_owner_person_id_idx" ON "roth_basis" USING btree ("owner_person_id");
