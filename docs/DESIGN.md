...
| Phase 2: Calculation Engine           | **COMPLETE**    | <!-- AUTO-GEN:calculators -->16<!-- /AUTO-GEN --> calculators + modular engine (<!-- AUTO-GEN:engineModules -->20<!-- /AUTO-GEN --> modules)                                                                                                                              |
...
- **<!-- AUTO-GEN:primaryRouters -->26<!-- /AUTO-GEN --> primary tRPC routers + <!-- AUTO-GEN:settingsSubRouters -->6<!-- /AUTO-GEN --> settings sub-routers** + shared helpers
...
| tRPC routers            | `src/server/routers/` (<!-- AUTO-GEN:primaryRouters -->26<!-- /AUTO-GEN --> primary + <!-- AUTO-GEN:settingsSubRouters -->6<!-- /AUTO-GEN --> settings sub-routers)                                                                                                                                                                                                                                                                                                                                                                                                                |
