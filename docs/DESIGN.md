...
| Phase                                 | Status          | Notes                                                                                                                                                                                                                                                                     |
| ------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase 1: Skeleton + Data Model + Seed | **COMPLETE**    | Schema (<!-- AUTO-GEN:migrations -->4<!-- /AUTO-GEN --> migration, <!-- AUTO-GEN:tables -->54<!-- /AUTO-GEN -->+ tables), seed script, <!-- AUTO-GEN:settingsComponents -->17<!-- /AUTO-GEN --> settings tabs                                                             |
...
```
ledgr/
├── drizzle/                    # <!-- AUTO-GEN:migrations -->4<!-- /AUTO-GEN --> migrations (initial schema + parent goal FK)
├── scripts/
