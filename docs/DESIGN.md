...
| Phase                                 | Status          | Notes                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Phase 1: Skeleton + Data Model + Seed | **COMPLETE**    | Schema (<!-- AUTO-GEN:migrations -->5<!-- /AUTO-GEN --> squashed baseline per release with dialect-specific PG/SQLite SQL, <!-- AUTO-GEN:tables -->62<!-- /AUTO-GEN -->+ tables), seed script, <!-- AUTO-GEN:settingsComponents -->19<!-- /AUTO-GEN --> settings tabs                                                                                                                                  |
...
| DB schema               | `src/lib/db/schema.ts` (<!-- AUTO-GEN:tables -->62<!-- /AUTO-GEN -->+ tables)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| tRPC routers            | `src/server/routers/` (<!-- AUTO-GEN:primaryRouters -->22<!-- /AUTO-GEN --> primary + <!-- AUTO-GEN:settingsSubRouters -->6<!-- /AUTO-GEN --> settings sub-routers)                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| Migrations              | `drizzle/` + `drizzle-sqlite/` (<!-- AUTO-GEN:migrations -->5<!-- /AUTO-GEN --> squashed baseline per release; PG in `drizzle/`, SQLite in `drizzle-sqlite/`)                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
Run `ls src/components/ui/` for the live list (<!-- AUTO-GEN:uiComponents -->22<!-- /AUTO-GEN --> components). Each
