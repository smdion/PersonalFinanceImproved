...
| Phase                                 | Status          | Notes                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Phase 1: Skeleton + Data Model + Seed | **COMPLETE**    | Schema (<!-- AUTO-GEN:migrations -->22<!-- /AUTO-GEN --> squashed baseline per release with dialect-specific PG/SQLite SQL, <!-- AUTO-GEN:tables -->63<!-- /AUTO-GEN -->+ tables), seed script, <!-- AUTO-GEN:settingsComponents -->19<!-- /AUTO-GEN --> settings tabs                                                                                                                                 |
...
| Migrations              | `drizzle/` + `drizzle-sqlite/` (<!-- AUTO-GEN:migrations -->22<!-- /AUTO-GEN --> squashed baseline per release; PG in `drizzle/`, SQLite in `drizzle-sqlite/`)                                                                                                                                                                                                                                                                                                                                                                                                                       |
