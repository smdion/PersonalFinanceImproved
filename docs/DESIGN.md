...
| Phase                                 | Status          | Notes                                                                                                                                                                                                                                                                     |
| ------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase 1: Skeleton + Data Model + Seed | **COMPLETE**    | Schema (<!-- AUTO-GEN:migrations -->2<!-- /AUTO-GEN --> squashed baseline per release with dialect-specific PG/SQLite SQL, <!-- AUTO-GEN:tables -->56<!-- /AUTO-GEN -->+ tables), seed script, <!-- AUTO-GEN:settingsComponents -->17<!-- /AUTO-GEN --> settings tabs     |
