...
| Phase                                 | Status          | Notes                                                                                                                                                                                                                                                                     |
| ------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase 1: Skeleton + Data Model + Seed | **COMPLETE**    | Schema (<!-- AUTO-GEN:migrations -->2<!-- /AUTO-GEN --> migration, <!-- AUTO-GEN:tables -->53<!-- /AUTO-GEN -->+ tables), seed script, <!-- AUTO-GEN:settingsComponents -->17<!-- /AUTO-GEN --> settings tabs                                                             |
...
```
ledgr/
├── drizzle/                    # <!-- AUTO-GEN:migrations -->2<!-- /AUTO-GEN --> migrations (initial schema + parent goal FK)
├── scripts/
...
│   │   │   └── schema.ts       # All table definitions (<!-- AUTO-GEN:tables -->53<!-- /AUTO-GEN -->+ tables)
