...
- **<!-- AUTO-GEN:primaryRouters -->19<!-- /AUTO-GEN --> primary tRPC routers + <!-- AUTO-GEN:settingsSubRouters -->6<!-- /AUTO-GEN --> settings sub-routers** + shared helpers
...
| tRPC routers            | `src/server/routers/` (<!-- AUTO-GEN:primaryRouters -->19<!-- /AUTO-GEN --> primary + <!-- AUTO-GEN:settingsSubRouters -->6<!-- /AUTO-GEN --> settings sub-routers)                                                                                                                                                                                                                                                                                                                                                                                                                 |
