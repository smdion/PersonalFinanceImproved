...
| Phase                                 | Status          | Notes                                                                                                                                                                                                                                                                     |
| ------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase 1: Skeleton + Data Model + Seed | **COMPLETE**    | Schema (<!-- AUTO-GEN:migrations -->4<!-- /AUTO-GEN --> migration, <!-- AUTO-GEN:tables -->55<!-- /AUTO-GEN -->+ tables), seed script, <!-- AUTO-GEN:settingsComponents -->17<!-- /AUTO-GEN --> settings tabs                                                             |
...
| DB schema               | `src/lib/db/schema.ts` (<!-- AUTO-GEN:tables -->55<!-- /AUTO-GEN -->+ tables)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| Migrations              | `drizzle/` (<!-- AUTO-GEN:migrations -->4<!-- /AUTO-GEN --> migration, v0.5 squashed)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
