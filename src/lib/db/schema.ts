...
export const payPeriodEnum = pgEnum("pay_period_enum", [
  "weekly",
  "biweekly",
  "semimonthly",
  "monthly",
...
export const payWeekEnum = pgEnum("pay_week_enum", ["even", "odd", "na"]);

export const taxTreatmentEnum = pgEnum("tax_treatment_enum", [
  "pre_tax",
  "tax_free",
  "after_tax",
  "hsa",
...
export const matchTaxTreatmentEnum = pgEnum("match_tax_treatment_enum", [
  "pre_tax",
  "tax_free",
]);

export const contributionMethodEnum = pgEnum("contribution_method_enum", [
  "percent_of_salary",
  "fixed_per_period",
  "fixed_monthly",
  "fixed_annual",
...
export const employerMatchTypeEnum = pgEnum("employer_match_type_enum", [
  "none",
...
export const hsaCoverageTypeEnum = pgEnum("hsa_coverage_type_enum", [
  "self_only",
  "family",
]);

export const accountOwnershipEnum = pgEnum("account_ownership_enum", [
  "individual",
  "joint",
]);

export const w4FilingStatusEnum = pgEnum("w4_filing_status_enum", [
  "MFJ",
  "Single",
  "HOH",
]);

export const budgetApiServiceEnum = pgEnum("budget_api_service_enum", [
  "ynab",
  "actual",
]);

export const apiSyncDirectionEnum = pgEnum("api_sync_direction_enum", [
  "pull",
  "push",
  "both",
]);

export const portfolioTaxTypeEnum = pgEnum("portfolio_tax_type_enum", [
  "preTax",
  "taxFree",
  "hsa",
  "afterTax",
...
// waterfall_category_enum removed in migration 0023 — account_type is now plain text,
// validated at the app layer via ACCOUNT_TYPE_CONFIG keys.
...
export const jobs = pgTable(
  "jobs",
  {
    ...
    payWeek: payWeekEnum("pay_week").notNull(),
    ...
    w4FilingStatus: w4FilingStatusEnum("w4_filing_status").notNull(),
...
export const contributionAccounts = pgTable(
  "contribution_accounts",
  {
    ...
    employerMatchType: employerMatchTypeEnum("employer_match_type").notNull(),
    ...
    employerMatchTaxTreatment: matchTaxTreatmentEnum(
      "employer_match_tax_treatment",
    )
      .notNull()
      .default("pre_tax"),
    hsaCoverageType: hsaCoverageTypeEnum("hsa_coverage_type"),
    autoMaximize: boolean("auto_maximize").notNull().default(false),
    isActive: boolean("is_active").notNull().default(true),
    ownership: accountOwnershipEnum("ownership")
      .notNull()
      .default("individual"),
...
export const performanceAccounts = pgTable(
  "performance_accounts",
  {
    ...
    ownershipType: accountOwnershipEnum("ownership_type").notNull(),
...
export const portfolioAccounts = pgTable(
  "portfolio_accounts",
  {
    ...
    institution: text("institution").notNull(),
    taxType: portfolioTaxTypeEnum("tax_type").notNull(),
    amount: decimal("amount", { precision: 12, scale: 2 }).notNull(),
    accountType: text("account_type").notNull(),
    subType: text("sub_type"),
    label: text("label"),
...
export const taxBrackets = pgTable(
  "tax_brackets",
  {
    id: serial("id").primaryKey(),
    taxYear: integer("tax_year").notNull(),
    filingStatus: w4FilingStatusEnum("filing_status").notNull(),
...
export const budgetApiCache = pgTable(
  ...
  {
    id: serial("id").primaryKey(),
    service: budgetApiServiceEnum("service").notNull(),
