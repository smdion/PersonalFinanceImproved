...
- **For a household where two people each have an account with the exact same name (e.g. both named "Long Term Brokerage"), an ongoing contribution continuing into retirement could be silently credited to the wrong person's account.** Now matched by owner as well as name.
